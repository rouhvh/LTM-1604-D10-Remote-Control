...
public class RemoteControlServer extends UnicastRemoteObject implements IRemoteControl {
    ...
    private volatile boolean isStreamPaused = false;
    ...
    @Override
    public void toggleScreenStream(boolean isPaused) throws RemoteException {
        this.isStreamPaused = isPaused;
        System.out.println("Server: Screen stream " + (isPaused ? "paused." : "resumed."));
    }
    ...
    public byte[] takeScreenshot() throws RemoteException {
        try {
            ...
            // Nén ảnh PNG (chất lượng cao nhất) để gửi về
            ByteArrayOutputStream baos = new ByteArrayOutputStream();
            ImageIO.write(screenCapture, "png", baos);
            return baos.toByteArray();
        } catch (Exception e) {
            throw new RemoteException("Failed to take screenshot.", e);
        }
    }
